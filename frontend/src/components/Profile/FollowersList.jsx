...
const FollowersList = ({ userId }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-3)' }}>
      {users.map(u => {
        // Backend typically returns follow documents containing populated 'follower' user
        const fUser = u.follower || u; 
        return (
          <div key={fUser._id} style={{
            ...
            {/* The current logged in user could unfollow/follow, but logic needs useProfile hook context for each. Keeping simple. */}
